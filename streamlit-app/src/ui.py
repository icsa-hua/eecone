...
def display_sidebar_header() -> None:
    ...
    with st.sidebar:
        ...
        col1.markdown(
            f"""
            <p><a style='display: block; text-align: center;' href={repo_link} > Source code</a></p>""",
            unsafe_allow_html=True,
        )
        col2.markdown(
            f"<p><a style='display: block; text-align: center;' href={evidently_docs} > Evidently docs</a></p>",
            unsafe_allow_html=True,
        )
